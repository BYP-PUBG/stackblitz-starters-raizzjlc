  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gray-950 px-4">
      <div className="w-full max-w-md">
        ...
        <p className="text-gray-500 text-sm mb-2">ดู inventory และ ranking ไอเทม PUBG ของคุณ</p>
        <a href="/market" className="text-xs text-blue-400 hover:text-blue-300 mb-8 inline-block">
